        ...
        <table class="table table-bordered" id="product-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            @foreach($products as $product)
              ...
              // dd($sub_cat_info);
              $supplier=DB::table('supplier')->select('title')->where('id',$product->supplier_id)->get();
              $brands=DB::table('brand')->select('title')->where('id',$product->brand_id)->get();
              @endphp
                <tr>
                    <td>{{$product->id}}</td>
                    <td>{{$product->title}}</td>
                    ...
                    <td>{{ucfirst($product->supplier->title)}}</td>
