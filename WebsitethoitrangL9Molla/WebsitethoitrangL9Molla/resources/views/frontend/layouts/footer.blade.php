<footer class="footer footer-dark">
    <div class="footer-middle">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    ...
                    <div class="widget widget-about">
                       @foreach($settings as $setting)
                        <img src="{{$setting->photo}}" class="footer-logo" alt="Footer Logo" width="105" height="25">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title">Danh Mục</h4><!-- End .widget-title -->
                        @php
                            $danhmuc=DB::table('categories')->where('is_parent',1)->where('status','active')->limit(5)->get();
                        @endphp
                        <ul class="widget-list">
                            @foreach ($danhmuc as $danhmucs)
                            <li><a href="{{route('product-cat',$danhmucs->slug)}}">{{$danhmucs->title}}</a></li>
                            @endforeach
                        </ul><!-- End .widget-list -->
                    </div><!-- End .widget -->
                </div><!-- End .col-sm-6 col-lg-3 -->
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="widget">
                        <h4 class="widget-title">Thương Hiệu</h4><!-- End .widget-title -->
                        @php
                            $thuonghieu=DB::table('brand')->where('status','active')->get();
                        @endphp
                        <ul class="widget-list">
                            @foreach ($thuonghieu as $data)
                                <li><a href="{{route('product-brand',$data->id)}}">{{$data->title}}</a></li>
                            @endforeach
                        </ul><!-- End .widget-list -->
                    </div><!-- End .widget -->
                </div><!-- End .col-sm-6 col-lg-3 -->
    ...
    <div class="footer-bottom">
        <div class="container">
            <p class="footer-copyright">Copyright © 2022 Nguyễn Chánh Tôn 18CT3</p><!-- End .footer-copyright -->
                            ...
                            <form action="{{route('login.submit')}}" method="POST">
                                ...
                                <div class="form-footer">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="signin-remember">Nhớ đăng nhập</label>
